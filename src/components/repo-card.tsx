...
import { ArrowRight, FolderGit2, Sparkles, Trash2 } from "lucide-react";
...
export function RepoCard({
  ...
  return (
    <Card className="group flex h-full flex-col rounded-[2rem] p-5 transition hover:-translate-y-1 hover:shadow-halo">
      ...
      <div className="mt-auto flex items-center justify-between gap-3 text-sm text-slate-500">
        ...
        <div className="flex items-center gap-2">
          ...
          <Link href={`/repos/${repo.id}`} className="inline-flex items-center gap-1 font-medium text-ink">
            Open board
